  ...
  ({ className, label, error, id, containerClassName, ...props }, ref) => {
    ...
    const inputEl = (
      <input
        ...
        className={cn(
          "w-full rounded-sm border border-input bg-input-background px-3.5 py-3 text-[0.9375rem] text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-primary focus:shadow-sm",
          className
        )}
        {...props}
      />
